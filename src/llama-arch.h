...
enum llm_tensor {
    ...
    LLM_TENSOR_HELIX_ROUTER_GATE,
    LLM_TENSOR_HELIX_CLUSTER_MAP,
    LLM_TENSOR_HELIX_FFN_GATE_EXPS,
    LLM_TENSOR_HELIX_FFN_UP_EXPS,
    LLM_TENSOR_HELIX_FFN_DOWN_EXPS,
    LLM_TENSOR_HELIX_SHARED_CORE_GATE,
    LLM_TENSOR_HELIX_SHARED_CORE_UP,
    LLM_TENSOR_HELIX_SHARED_CORE_DOWN,
    LLM_TENSOR_HELIX_MAGNET_A,
    LLM_TENSOR_HELIX_MAGNET_B,
};
